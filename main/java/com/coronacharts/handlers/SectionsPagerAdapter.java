...
import com.coronacharts.appCurrentActivities.FragmentGraphs;
...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    @StringRes
    private static final int[] TAB_TITLES = new int[]{R.string.by_city_fragment_title, R.string.country_sickness_stat, R.string.graphs_frag_title,  R.string.states_list};
